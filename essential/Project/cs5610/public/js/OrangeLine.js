function OrangeFn($scope, $http, $sce) {
    ...
    $scope.searchfn = function () {
        ...
        $http.get("/orangestations/" + FromStation).success(function (response) {
            ...
            $http.get("/orangestations/" + ToStation).success(function (response) {
                console.log(" To station ::::::::::::::::: "+response);
                ...
                $http.get("http://realtime.mbta.com/developer/api/v2/schedulebyroute?api_key=TbUOod1u00WYU5oe6x7h1g&route=orange&format=json")
